  ...
  return (
    <div
      className={classNames(
        "flex flex-col items-center justify-start min-h-[100dvh] pt-28 md:pt-24 pb-28 md:pb-12 px-4 transition-colors duration-300 ease-in-out",
        theme.secondary,
      )}
    >
      <Header />

      <main className="flex-1 flex flex-col items-center w-full max-w-md mx-auto py-4 sm:py-6">
        <div className="my-auto w-full bg-white/70 backdrop-blur-lg border border-white/40 shadow-xl rounded-[32px] p-5 sm:p-6 md:p-8 flex flex-col items-center text-center gap-4 sm:gap-6 transition-all duration-300">
          {/* Header Info */}
          ...
          {/* QR Code Container */}
          <div className="relative group flex flex-col items-center gap-3 sm:gap-4 bg-white p-3.5 sm:p-4.5 rounded-[24px] border border-slate-200/50 shadow-inner w-full max-w-[220px] sm:max-w-[240px]">
            <div className="overflow-hidden rounded-2xl border border-slate-100 shadow-sm">
              <Image
                src={shareQRcode}
                className="h-36 w-36 sm:h-44 sm:w-44 object-cover transform transition-transform duration-300 group-hover:scale-105"
            ...
            <a
              ...
              className={classNames(
                "flex items-center justify-center gap-2 w-full py-2 sm:py-2.5 px-4 rounded-xl text-xs font-bold text-white shadow-md transition-all duration-300 active:scale-95 hover:shadow-lg hover:brightness-105 cursor-pointer",
                theme.primary,
              )}
            >
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2 w-full">
            ...
            <div className="flex items-center bg-white/80 border border-slate-200/80 rounded-2xl p-1 sm:p-1.5 shadow-sm">
